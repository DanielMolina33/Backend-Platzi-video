const moviesMock = [
  {
    id: '5f2c2fbcbbd2a533a076b0d2',
    title: 'Notti bianche, Le (White Nights)',
    year: 2019,
    cover: 'http://dummyimage.com/800x600.png/ff4444/ffffff',
    description:'In hac habitasse platea dictumst. Etiam faucibus cursus urna. Ut tellus. In hac habitasse platea dictumst. Etiam faucibus cursus urna. Ut tellus. In hac habitasse platea dictumst. Etiam faucibus cursus urna. Ut tellus. In hac habitasse platea dictumst. Etiam faucibus cursus urna. Ut tellusoooooooooo',
    duration: 66,
    contentRating: 'G',
  ...
  },
  {
    ...
    description: 'This is short description for my movie',
    duration: 77,
    contentRating: 'NC-17',
